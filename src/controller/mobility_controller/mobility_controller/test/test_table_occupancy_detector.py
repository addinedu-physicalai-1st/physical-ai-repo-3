...
실행:
  ...
  python3 -m pytest src/controller/mobility_controller/mobility_controller/test/test_table_occupancy_detector.py -v
"""
...
from table_occupancy_detector_node import (  # noqa: E402
