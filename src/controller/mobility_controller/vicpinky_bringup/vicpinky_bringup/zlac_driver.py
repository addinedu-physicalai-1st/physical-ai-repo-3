...
class ZLACDriver:
    def __init__(self, port, baudrate, modbus_id):
        ...
        self.GET_BUS_VOLTAGE = 0x20A1   # bus voltage, raw value /100 = V
    ...
    def get_bus_voltage(self):
        """Read ZLAC bus (battery) voltage in V. Returns float or None."""
        cmd_body = struct.pack('>BBHH', self.modbus_id, self.READ, self.GET_BUS_VOLTAGE, 1)
