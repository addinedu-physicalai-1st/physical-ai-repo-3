...
실행:
  ...
  python3 -m pytest src/dobi_npc/dobi_npc_bringup/test/test_patrol_scheduler.py -v
"""
...
from dobi_npc_bringup.patrol_scheduler_node import PatrolScheduler, State
