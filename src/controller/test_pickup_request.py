#!/usr/bin/env python3
"""
test_pickup_request.py — serving.py Pickup 실제 호출 테스트

실행:
  터미널 1: source install/setup.bash && ros2 run single_arm_controller serving
  터미널 2: source install/setup.bash && python3 src/controller/test_pickup_request.py
"""
