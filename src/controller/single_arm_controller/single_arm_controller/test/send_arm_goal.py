#!/usr/bin/env python3
"""
send_arm_goal.py — ACT 액션 서버에 Pickup / Serve 목표를 수동으로 전송한다.

사용법:
  python3 send_arm_goal.py pickup
  python3 send_arm_goal.py serve --has-drink
  python3 send_arm_goal.py serve --no-drink
  python3 send_arm_goal.py pickup --timeout 60
"""
...
class ArmGoalSender(Node):
    def __init__(self):
        super().__init__('arm_goal_sender')
...
def main():
    parser = argparse.ArgumentParser(
        description='ACT 액션 서버에 Pickup / Serve 목표를 전송한다.',
