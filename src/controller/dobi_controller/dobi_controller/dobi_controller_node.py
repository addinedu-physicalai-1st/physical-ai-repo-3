...
def create_service_status_handler(node: 'DobiControllerNode'):
...
class DobiControllerNode(Node):
    def __init__(self):
        ...
        self._server_thread = threading.Thread(
            ...
            name='dobi-controller-tcp-bridge',
            daemon=True,
        )
        self._server_thread.start()
        self.get_logger().info(f'{controller_name} started')
        self.get_logger().info(
            f'bridging dobi_controller status to control_service TCP '
    ...
    def _handle_health_check(self, request, response):
        ...
        response.message = 'dobi_controller health status published'
        return response
