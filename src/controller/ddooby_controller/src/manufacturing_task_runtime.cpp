...
bool HotdogMakingNode::shouldStopAfterWaypoint(ManufacturingStage stage, const std::string & waypoint) const
{
...
{
    return ddooby_controller::manufacturing_task::shouldStopAtOrBeforeWaypointStage(
      play_to_waypoint_,
      stage);
  }

bool HotdogMakingNode::configureTaskArm(
    moveit::planning_interface::MoveGroupInterface & arm,
    const std::string & tcp_link,
    double velocity_scaling,
    double acceleration_scaling)
{
    return configureArmGroupForTask(
      arm,
      planning_time_sec_,
      planning_attempts_,
      velocity_scaling,
...
void HotdogMakingNode::configureTaskGripper(moveit::planning_interface::MoveGroupInterface & gripper)
{
    configureGripperGroupForTask(
      gripper,
      gripper_velocity_scaling_,
      gripper_acceleration_scaling_);
  }

bool HotdogMakingNode::planAndExecuteReturnHome(
    moveit::planning_interface::MoveGroupInterface & arm,
...
bool HotdogMakingNode::runSingleArmReturnHome(
    ManufacturingTarget target,
    ArmSide arm_side,
