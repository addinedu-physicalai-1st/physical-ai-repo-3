...
class MapManagementPage(QWidget):
    def __init__(self):
        ...
        g = QGridLayout()
        self.e_name = QLineEdit(MAP_PROPERTIES['name'])
        self.e_loc = QLineEdit(MAP_PROPERTIES['location'])
        self.e_w = QLineEdit(MAP_PROPERTIES['width'])
        self.e_h = QLineEdit(MAP_PROPERTIES['height'])
